...
notebook_content = {
    "cells": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "d6581a815af6"},
            "source": [
                "<table align=\"left\">\n",
                " <td style=\"text-align: center\">\n",
                " <a href=\"https://colab.research.google.com/github/google-a2a/a2a-samples/blob/main/notebooks/a2a_quickstart.ipynb\">\n",
                " <img width=\"32px\" src=\"https://www.gstatic.com/pantheon/images/bigquery/welcome_page/colab-logo.svg\" alt=\"Google Colaboratory logo\">\nOpen in Colab\n",
                " \n",
                " \n",
                " <td style=\"text-align: center\">\n",
                " <a href=\"https://console.cloud.google.com/vertex-ai/colab/import/https:%2F%2Fraw.githubusercontent.com%2Fgoogle-a2a%2Fa2a-samples%2Fmain%2Fnotebooks%2Fa2a_quickstart.ipynb\">\n",
                " <img width=\"32px\" src=\"https://lh3.googleusercontent.com/JmcxdQi-qOpctIvWKgPtrzZdJJK-J3sWE1RsfjZNwshCFgE_9fULcNpuXYTilIR2hjwN\" alt=\"Google Cloud Colab Enterprise logo\">\nOpen in Colab Enterprise\n",
                " \n",
                " \n",
                " <td style=\"text-align: center\">\n",
                " <a href=\"https://console.cloud.google.com/vertex-ai/workbench/deploy-notebook?download_url=https://raw.githubusercontent.com/google-a2a/a2a-samples/main/notebooks/a2a_quickstart.ipynb\">\n",
                " <img src=\"https://www.gstatic.com/images/branding/gcpiconscolors/vertexai/v1/32px.svg\" alt=\"Vertex AI logo\">\nOpen in Vertex AI Workbench\n",
                " \n",
                " \n",
                " <td style=\"text-align: center\">\n",
                " <a href=\"https://console.cloud.google.com/bigquery/import?url=https://github.com/google-a2a/a2a-samples/blob/main/notebooks/a2a_quickstart.ipynb\">\n",
                " <img src=\"https://www.gstatic.com/images/branding/gcpiconscolors/bigquery/v1/32px.svg\" alt=\"BigQuery Studio logo\">\nOpen in BigQuery Studio\n",
                " \n",
                " \n",
                " <td style=\"text-align: center\">\n",
                " <a href=\"https://github.com/google-a2a/a2a-samples/blob/main/notebooks/a2a_quickstart.ipynb\">\n",
        ...
        },
        {
            ...
            "source": [
                ...
                " - Getting Started with Agent-to-Agent (A2A) Protocol: Gemini on Cloud Run\n",
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "9b8e4fde0015"},
            "outputs": [],
            "source": [
                "# Install required packages\n",
                "%pip install --upgrade -q google-genai google-adk a2a-sdk python-dotenv aiohttp uvicorn requests mermaid-python nest-asyncio"
            ]
        },
        {
            "cell_type": "markdown",
            "metadata": {"id": "415604558ae1"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "8991eb966e73"},
            "source": ["### Environment Configuration"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "2c229a99c6b8"},
            "outputs": [],
            "source": [
                "import os\n",
                "import sys\n",
                ...
                "\n",
                "\n",
                "# Set Google API Configuration for Gemini\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "                [Part(root=TextPart(text=response_text))],\n", # Corrected line: removed extra curly brace
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "32126e55fe6f"},
            "source": ["### A2A Server for Analyzer Agent"]
        },
        {
            "cell_type": "code",
            "execution_count": 7,
            "metadata": {"id": "bf8d63f7c665"},
            "outputs": [],
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "c54d9b0ad632"},
            "source": ["### A2A Server for Trending Agent"]
        },
        {
            "cell_type": "code",
            "execution_count": 8,
            "metadata": {"id": "d63836c6116a"},
            "outputs": [],
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "ba54b4377683"},
            "source": ["### A2AToolClient for the Host Agent (Orchestrator) to use and communicate with remote agents"]
        },
        {
            "cell_type": "code",
            "execution_count": 9,
            "metadata": {"id": "c2189ba92e8a"},
            "outputs": [],
            "source": [
                "import json\n",
                "import uuid\n",
                ...
                "                            for part_item in artifact['parts']:\n", # Renamed part to part_item to avoid conflict
        ...
        },
        {
            "cell_type": "code",
            "execution_count": 10,
            "metadata": {"id": "42ff7b5b6433"},
            "outputs": [],
            "source": ["a2a_client = A2AToolClient()"]
        },
        {
            "cell_type": "markdown",
            "metadata": {"id": "18e76145ebd4"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "23107c1cffff"},
            "source": ["### A2A Server for Host Agent"]
        },
        {
            "cell_type": "code",
            "execution_count": 12,
            "metadata": {"id": "ba5917c5e95a"},
            "outputs": [],
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "4bd7b8ad6e23"},
            "source": ["### Test Agent Discovery"]
        },
        {
            "cell_type": "code",
            "execution_count": 14,
            "metadata": {"id": "03e7b1c16c1a"},
            "outputs": [],
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "7835060e463f"},
            "source": ["### Test Direct Agent Communication"]
        },
        {
            "cell_type": "code",
            "execution_count": 15,
            "metadata": {"id": "a8a1d8d5055d"},
            "outputs": [],
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "79cb294d575b"},
            "source": ["### Run the Complete Host Agent"]
        },
        {
            "cell_type": "code",
            "execution_count": 17,
            "metadata": {"id": "524a44a8cb18"},
            "outputs": [],
            "source": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "\n",
                "Use Direct ADK for Multi-Agents System When:\n",
                "\n",
                ...
                "\n",
                "Use A2A for Multi-Agents System When:\n",
                "\n",
...
try:
    with open('a2a_quickstart.ipynb', 'w', encoding='utf-8') as f:
        json.dump(notebook_content, f, indent=1) # Standard JSON indent for notebooks
    print('Successfully created/overwritten a2a_quickstart.ipynb with the new A2A content.')
except IOError as e:
